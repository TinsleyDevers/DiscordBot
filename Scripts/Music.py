...
async def play(ctx, *url: str):
    ...
    await ctx.send("<a:AnimatedCheckmark:793787234095464499> **Success** | *Downloading your song!* <a:AnimatedCheckmark:793787234095464499>\n<:DND:793788606266212353> **PLEASE WAIT WHILE YOUR SONG DOWNLOADS** <:DND:793788606266212353>")
...
# Music Bot- Stop
@client.command(pass_context=True, aliases=['s', 'sto', 'skip'])
async def stop(ctx):
    voice = get(client.voice_clients, guild=ctx.guild)
